      ...
      <header className="bg-white border-b py-6">
        <div className="container flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button_1.Button onClick={function () { return navigate("/login"); }} className="bg-iraav-dark-blue hover:bg-iraav-navy">
      ...
      <main className="flex-1">
        <section className="bg-gradient-to-b from-white to-iraav-bg-light py-20">
          <div className="container text-center">
            ...
            <div className="mt-10">
              <button_1.Button onClick={function () { return navigate("/login"); }} size="lg" className="bg-iraav-dark-blue hover:bg-iraav-navy">
                Get Started
              </button_1.Button>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-iraav-bg-light p-6 rounded-lg text-center">
                <div className="bg-iraav-accent-yellow w-14 h-14 mx-auto rounded-full flex items-center justify-center mb-4">
                  <lucide_react_1.BarChart className="h-7 w-7 text-iraav-dark-blue"/>
                </div>
              ...
              <div className="bg-iraav-bg-light p-6 rounded-lg text-center">
                <div className="bg-iraav-accent-yellow w-14 h-14 mx-auto rounded-full flex items-center justify-center mb-4">
                  <lucide_react_1.ShoppingCart className="h-7 w-7 text-iraav-dark-blue"/>
                </div>
              ...
              <div className="bg-iraav-bg-light p-6 rounded-lg text-center">
                <div className="bg-iraav-accent-yellow w-14 h-14 mx-auto rounded-full flex items-center justify-center mb-4">
                  <lucide_react_1.Package className="h-7 w-7 text-iraav-dark-blue"/>
                </div>
